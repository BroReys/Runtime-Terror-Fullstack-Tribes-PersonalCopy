...
@Component({
  selector: 'app-with-spy-report',
  templateUrl: './with-spy-report.component.html',
  styleUrls: ['./with-spy-report.component.scss']
})
export class WithSpyReportComponent implements OnInit {
