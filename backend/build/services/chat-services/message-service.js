...
var _messageRepository = _interopRequireDefault(require("../../repositories/chat-repositories/message-repository"));
    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _messageRepository["default"].createMessage(textOfMessage, chat, author);
